...
| MCP-001 | architecture/MCP design | stdio server + Control client | MCP server/client/package tests | MCP→ASGI/photo fallback; live `/v1/skills` discovery and `skill_view` use | Host Green / live Skill path Green / project MCP ingestion pending |
