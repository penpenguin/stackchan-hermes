...
// Derived from locked 78/esp-ml307 3.6.5 src/http_client.cc.
// Changes: suppress credential logging; parse final responses after informational headers.
...
std::string HttpClient::BuildHttpRequest() {
    ...
    // 结束头部
    request << "\r\n";
    // Request headers contain authentication credentials and must never be logged.
