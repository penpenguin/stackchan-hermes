...
void Motion::moveFromAuthenticatedBridgeWithSpeed(int yawAngle, int pitchAngle, int speed)
{
    _yaw_servo->moveFromAuthenticatedBridgeWithSpeed(yawAngle, speed);
    _pitch_servo->moveFromAuthenticatedBridgeWithSpeed(pitchAngle, speed);
}
...
void Motion::setLocalMotionLocked(bool locked)
{
    _yaw_servo->setLocalMotionLocked(locked);
    _pitch_servo->setLocalMotionLocked(locked);
}
