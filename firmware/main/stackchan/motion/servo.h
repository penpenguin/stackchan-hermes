...
public:
    ...
    void moveFromAuthenticatedBridgeWithSpeed(int angle, int speed);

    void setLocalMotionLocked(bool locked);
    bool localMotionLocked() const;
...
protected:
    ...
    bool allowsMotionCommand(stackchan::bridge_client::MotionCommandSource source) const;
    bool allowsTorqueCommand(bool enabled, stackchan::bridge_client::MotionCommandSource source) const;
...
protected:
    ...
    stackchan::bridge_client::MotionCommandSafety _command_safety;

    void apply_default_spring_options();
    void move_with_spring_params_impl(int angle, float stiffness, float damping);
    void move_with_speed_impl(int angle, int speed);
